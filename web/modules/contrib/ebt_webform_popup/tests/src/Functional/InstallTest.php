...
namespace Drupal\Tests\ebt_webform_popup\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ebt_webform_popup'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ebt_webform_popup']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ebt_webform_popup');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ebt_webform_popup'));
