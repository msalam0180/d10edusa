...
namespace Drupal\Tests\ebt_quote\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ebt_quote'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ebt_quote']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ebt_quote');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ebt_quote'));
