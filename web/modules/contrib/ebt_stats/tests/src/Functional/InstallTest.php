...
namespace Drupal\Tests\ebt_stats\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ebt_stats'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ebt_stats']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ebt_stats');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ebt_stats'));
