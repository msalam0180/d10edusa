...
Extra Block Types: Timeline module provides ability
to add a block with timeline.

For a full description of the module, visit the
[project page](drupal.org/project/ebt_timeline12).

Submit bug reports and feature suggestions, or track changes in the
[issue queue](https://www.drupal.org/project/issues/ebt_timeline).
...
- If you use Field Layout module,
  ...
  `/admin/structure/block/block-content/manage/ebt_timeline/display/default`
