...
namespace Drupal\Tests\ebt_timeline\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ebt_timeline'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ebt_timeline']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ebt_timeline');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ebt_timeline'));
