...
namespace Drupal\Tests\ebt_counter\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ebt_counter'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ebt_counter']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ebt_counter');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ebt_counter'));
