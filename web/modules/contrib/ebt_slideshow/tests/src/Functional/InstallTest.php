...
namespace Drupal\Tests\ebt_slideshow\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ebt_slideshow'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ebt_slideshow']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ebt_slideshow');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ebt_slideshow'));
