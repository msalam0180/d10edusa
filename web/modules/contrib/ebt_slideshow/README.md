...
Extra Block Types: Slideshow module provides ability
to add a block with FlexSlider.
http://flexslider.woothemes.com/

EBT Slideshow also allows to display carousel as well
(with animation:slide option):
 ...
 * If you use Field Layout module,
   ...
   /admin/structure/block/block-content/manage/ebt_slideshow/display/default
