...
namespace Drupal\Tests\ebt_text\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ebt_text'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ebt_text']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ebt_text');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ebt_text'));
