...
Extra Block Types: Image Gallery module provides ability
to add an Image Gallery with GLightbox.
https://biati-digital.github.io/glightbox/

EBT Image Gallery is based on paragraphs and Drupal fields,
so you can easily change image size or add Colorbox using Fields UI.

For a full description of the module, visit the
[project page](https://www.drupal.org/project/ebt_image_gallery).

Submit bug reports and feature suggestions, or track changes in the
[issue queue](https://www.drupal.org/project/issues/ebt_image_gallery).
...
**Q: Can I use only one EBT block type, for example EBT Image Gallery, without other modules?**
