...
namespace Drupal\Tests\ebt_image_gallery\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ebt_image_gallery'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ebt_image_gallery']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ebt_image_gallery');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ebt_image_gallery'));
