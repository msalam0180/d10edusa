...
namespace Drupal\Tests\ebt_slick_slider\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ebt_slick_slider'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ebt_slick_slider']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ebt_slick_slider');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ebt_slick_slider'));
