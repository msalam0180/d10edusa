...
[project page](https://www.drupal.org/project/ebt_bootstrap_button).

Submit bug reports and feature suggestions, or track changes in the
[issue queue](https://www.drupal.org/project/issues/ebt_bootstrap_button).
...
**A:** A: Yes, sure. EBT block types tend to be standalone modules.
