...
namespace Drupal\Tests\ebt_bootstrap_button\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ebt_bootstrap_button'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ebt_bootstrap_button']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ebt_bootstrap_button');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ebt_bootstrap_button'));
